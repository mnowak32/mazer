...
//            intersectsTriangleMT(origin, lookAt, face) || intersectsTriangleMT(origin, lookAt, face.reversed)
        ...
        internal fun intersectsTriangleMT(origin: Point, lookAt: Vector, face: Rect): Boolean {
...
//                    val t = face.v1 % qv * inv
        ...
        internal fun intersectsRectangleBasic(origin: Point, lookAt: Vector, face: Rect): Boolean {
            ...
            return onRightOf(face.p1, face.v1, p) &&
